...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--lr_step', type=str, default='25,40',
                             help='drop learning rate by 10.') #0406
    self.parser.add_argument('--num_epochs', type=int, default=200,
                             help='total training epochs.')   #epoch  #0412 200
    ...
    self.parser.add_argument('--val_intervals', type=int, default=1,
                             help='number of epochs to run validation.')  #0306  在这里改每几个epoch触发valid
    ...
    self.parser.add_argument('--frame_group_size', type=int, default=4,
                             help='number of camera views that belong to the '
                                  'same physical frame.')
    self.parser.add_argument('--camera_order', type=str,
                             default='front,right,left,back',
                             help='comma separated camera ordering used to '
                                  'pack one frame into a batch.')
    self.parser.add_argument('--multiview_nms_iou', type=float, default=0.1,
                             help='BEV IoU threshold used to suppress '
                                  'duplicate lidar boxes across cameras.')
    ...
    self.parser.add_argument('--aug_ddd', type=float, default=0.9,
                             help='probability of applying crop augmentation.') #0406
    ...
    self.parser.add_argument('--norm_wh', action='store_true',
                             help='L1(y_hat / y, 1) or L1(y_hat, y)')
